...
<head>
  ...
  <title>About Us – <?= $page_title; ?></title>
      ...
      <section class="page_banner_section text-center" style="background-image: url('assets/images/shapes/bg_pattern_4.svg');">
        <div class="container">
          <div class="heading_focus_text text-white">
            About
            <span class="badge bg-secondary">More <?= $company_name; ?> 😃</span>
          </div>
            ...
            <div class="row justify-content-lg-between">
              <div class="col-lg-4">
                <div class="heading_focus_text">
                  About
                  <span class="badge bg-secondary text-white"><?= $company_name; ?> 🙂</span>
                </div>
              ...
              <div class="col-lg-6">
                <p class="heading_description mb-0">
                  At <?= $company_name; ?>, we pride ourselves on offering dynamic and IT to suit your specific requirements. Our flexible approach means we can adjust our offerings to accommodate your evolving needs, whether you require comprehensive IT infrastructure support, strategic consultancy, software development
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4">
              <div class="iconbox_block">
                ...
                <div class="iconbox_content">
                  <h3 class="iconbox_title">Leadership Team</h3>
                  <p class="mb-0" style="text-align: justify;">
                    We pride ourselves on a leadership team that brings extensive experience, diverse expertise, and a shared passion for driving innovation, achieving excellence, and fostering sustainable growth.
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="iconbox_block">
                ...
                <div class="iconbox_content">
                  ...
                  <p class="mb-0" style="text-align: justify;">
                    Our mission is to help customers achieve their goals with reliable, high-quality products and exceptional service, while upholding the highest ethical standards with transparency, fairness, and respect. </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="iconbox_block">
                ...
                <div class="iconbox_content">
                  ...
                  <p class="mb-0" style="text-align: justify;">
                    Our vision at <?= $company_name; ?> is to pioneer transformative innovations that revolutionize industries worldwide, inspiring positive change and creating lasting value for all stakeholders involved. </p>
                </div>
              </div>
            </div>
          </div>
